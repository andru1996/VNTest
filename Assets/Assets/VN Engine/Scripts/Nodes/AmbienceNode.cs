...
namespace VNEngine
{
    ...
    {
        [SerializeField] private float _setVolume = 1;
        ...
        public override void Run_Node()
        {
            if (new_ambience == AudioManager.audio_manager.ambience_audio_source.clip && AudioManager.audio_manager.ambience_audio_source.volume != 0)
            {
                ...
                AudioManager.audio_manager.ChangePlayingAmnienceVolume(_setVolume);
                Finish_Node();
                return;
            }
            ...
            else
            {
                ...
                AudioManager.audio_manager.Set_Ambience(new_ambience, _setVolume);
                Finish_Node();
            }
        }
