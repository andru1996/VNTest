...
public class GameGUI_GamingUI : Jun_ComponentSingletonObject <GameGUI_GamingUI> 
{
	...
	void Update ()
	{
		...
		timeText.text = Jun_GameTool.TimeString(GameController.instance.LoseTime - GameController.instance.gamingData.gameTime);
		timeBarImage.fillAmount = (float)(GameController.instance.LoseTime - GameController.instance.gamingData.gameTime) / (float)GameController.instance.LoseTime;
